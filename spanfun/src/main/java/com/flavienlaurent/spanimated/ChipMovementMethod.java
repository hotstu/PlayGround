...
public class ChipMovementMethod extends LinkMovementMethod {
    ...
    private static ChipMovementMethod singleInstance;
     ...
     * @param textViews   The TextViews on which a {@link ChipMovementMethod} should be registered.
     * @return The registered {@link ChipMovementMethod} on the TextViews.
     */
    public static ChipMovementMethod linkify(int linkifyMask, TextView... textViews) {
        ChipMovementMethod movementMethod = newInstance();
     ...
     * @return The registered {@link ChipMovementMethod} on the TextViews.
     */
    public static ChipMovementMethod linkifyHtml(TextView... textViews) {
        return linkify(LINKIFY_NONE, textViews);
    }

    /**
     * Recursively register a {@link ChipMovementMethod} on every TextView inside a layout.
     *
     * @param linkifyMask One of {@link Linkify#ALL}, {@link Linkify#PHONE_NUMBERS}, {@link Linkify#MAP_ADDRESSES},
     *                    {@link Linkify#WEB_URLS} and {@link Linkify#EMAIL_ADDRESSES}.
     * @return The registered {@link ChipMovementMethod} on the TextViews.
     */
    public static ChipMovementMethod linkify(int linkifyMask, ViewGroup viewGroup) {
        ChipMovementMethod movementMethod = newInstance();
    ...
    public static ChipMovementMethod linkifyHtml(ViewGroup viewGroup) {
     ...
     * @return The registered {@link ChipMovementMethod} on the TextViews.
     */
    public static ChipMovementMethod linkify(int linkifyMask, Activity activity) {
     ...
     */
    @SuppressWarnings("unused")
    public static ChipMovementMethod linkifyHtml(Activity activity) {
        return linkify(LINKIFY_NONE, activity);
    }

    /**
     * Get a static instance of ChipMovementMethod. Do note that registering a click listener on the returned
     * instance is not supported because it will potentially be shared on multiple TextViews.
     */
    @SuppressWarnings("unused")
    public static ChipMovementMethod getInstance() {
        if (singleInstance == null) {
            singleInstance = new ChipMovementMethod();
        }
        return singleInstance;
    }

    protected ChipMovementMethod() {
    }

    /**
     * Set a listener that will get called whenever any link is clicked on the TextView.
     */
    public ChipMovementMethod setOnLinkClickListener(OnLinkClickListener clickListener) {
     ...
     * Set a listener that will get called whenever any link is clicked on the TextView.
     */
    public ChipMovementMethod setOnLinkLongClickListener(OnLinkLongClickListener longClickListener) {
        if (this == singleInstance) {
...
// ======== PUBLIC APIs END ======== //
    ...
    private static void rAddLinks(int linkifyMask, ViewGroup viewGroup, ChipMovementMethod movementMethod) {
    ...
    private static void addLinks(int linkifyMask, ChipMovementMethod movementMethod, TextView textView) {
