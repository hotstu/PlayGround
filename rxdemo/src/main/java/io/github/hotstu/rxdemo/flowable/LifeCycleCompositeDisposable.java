 ...
 */
public final class LifeCycleCompositeDisposable implements Disposable, DisposableContainer, LifecycleObserver {
     ...
     */
    public LifeCycleCompositeDisposable(Lifecycle lifecycle) {
     ...
     */
    public LifeCycleCompositeDisposable(@NonNull Disposable... resources) {
     ...
     */
    public LifeCycleCompositeDisposable(@NonNull Iterable<? extends Disposable> resources) {
        ObjectHelper.requireNonNull(resources, "resources is null");
