package io.github.hotstu.uikit.widget.grouplayout;
...
import io.github.hotstu.uikit.R;
 ...
 * </p>
 * <p>
 * 提供了 {@link Section} 的概念, 用来将列表分块。 具体见 {@link GroupLayout.Section}
 * </p>
 * <p>
 * usage:
 * <pre>
...
public class GroupLayout extends LinearLayout {
    ...
    public GroupLayout(Context context) {
        this(context, null, R.attr.LFUIGroupListViewStyle);
    }

    public GroupLayout(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.LFUIGroupListViewStyle);
    }

    public GroupLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs);
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.LFUIGroupListView, defStyleAttr, 0);
        mSeparatorType = a.getInt(R.styleable.LFUIGroupListView_lfui_separatorType, SEPARATOR_STYLE_NORMAL);
        a.recycle();
    ...
    /**
     * private, use {@link Section#addTo(GroupLayout)}
    ...
    /**
     * private，use {@link Section#removeFrom(GroupLayout)}
    ...
    /**
     * Section 是组成 {@link GroupLayout} 的部分。
     * <ul>
    ...
    public static class Section {
        ...
        public Section setSeparatorDrawableRes(@DrawableRes int single,@DrawableRes int top,
                                               @DrawableRes int bottom, @DrawableRes int middle) {
        ...
        public Section setSeparatorDrawableRes(@DrawableRes int middle) {
            mSeparatorDrawableForMiddle = middle;
            return this;
        }

        /**
         * 将 Section 添加到 {@link GroupLayout} 上
         */
        public void addTo(GroupLayout groupListView) {
            if (mTitleView == null) {
        ...
        public void removeFrom(GroupLayout parent) {
